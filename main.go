...
import (
	...
	"github.com/MixinNetwork/near-sdk-go/rpc"
	"github.com/MixinNetwork/near-sdk-go/serialize"
	"github.com/MixinNetwork/near-sdk-go/transaction"
...
func main() {
	...
	if err != nil {
		log.Println("广播交易失败2：", err.Error())
		return
	}
	fmt.Println("Commit Txid: ", txid)
